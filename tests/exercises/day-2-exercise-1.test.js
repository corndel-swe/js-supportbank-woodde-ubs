...
import { makeToast, makeCoffee, makeBreakfast } from '../../exercises/breakfast.js';
...
describe('breakfast', () => {
    ...
    describe('makeCoffee', () => {
        ...
        it('should not resolve if coffee is still brewing', async () => {
            ...
            const makeCoffeePromise = makeCoffee(beans, grinder, coffeeMaker, cup);
    ...
    describe('makeBreakfast', () => {
        ...
        it('should use makeToast and makeCoffee', async () => {
            ...
            const breakfast = await makeBreakfast(bread, toaster, beans, grinder, coffeeMaker, cup);
